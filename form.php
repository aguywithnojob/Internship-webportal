...
<body class="not-transparent-header">
	...
	<div class="container-wrapper">
		...
		<div class="main-wrapper">
			...
			<section>
				<div class="section sm pb-20">
					...
					<div class="row">
						...
						<div class="col-sm-12 col-md-7 col-md-offset-1 mb-30">
						
							<form  method="post" class="contact-form-wrapper" data-toggle="validator" action="submit.php">
								...
								<div class="row">
									...
									<div class="col-md-12">
										...
										<div class="form-group">
											<label for="inputName">Full Name <span class="font10 text-danger">(required)</span></label>
									...
									<div class="col-md-8">
										...
										<div class="form-group">
											<label for="inputName">Date Of Birth <span class="font10 text-danger">(required)</span></label>
											<input id="inputName" name="dob" type="text" class="form-control" placeholder="DD/MM/YYYY" required>
											<div class="help-block with-errors"></div>
										</div>
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											<label for="inputName">Gender <span class="font10 text-danger">(required)</span></label>
											<input id="inputName" name="gender" type="text" class="form-control" required>
											<div class="help-block with-errors"></div>
										</div>
									...
									<div class="col-md-12">
										...
										<div class="form-group">
											<label for="inputName">Address <span class="font10 text-danger">(required)</span></label>
											<input id="inputName" name="address" type="text" class="form-control"  required>
											<div class="help-block with-errors"></div>
										</div>
									...
									<div class="col-md-12">
										...
										<div class="form-group">
											<label for="inputName">Phone(Mobile) <span class="font10 text-danger">(required)</span></label>
									...
									<div class="col-md-8">
										...
										<div class="form-group">
											<label for="inputEmail">Passport Number <span class="font10 text-danger">(required)</span></label>
											<input id="inputEmail"  name="passno"type="text" class="form-control"  required>
											<div class="help-block with-errors"></div>
										</div>
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											...
											<input id="inputEmail" name="exd" type="text" class="form-control" placeholder="DD/MM/YYYY"  required>
											<div class="help-block with-errors"></div>
										</div>
									...
									<div class="col-md-12">
										...
										<div class="form-group">
											<label for="inputName">Father's Name <span class="font10 text-danger">(required)</span></label>
											<input id="inputName" name="fname" type="text" class="form-control"  required>
											<div class="help-block with-errors"></div>
										</div>
									...
									<div class="col-md-12">
										...
										<div class="form-group">
											<label for="inputName">Father's occupation <span class="font10 text-danger">(required)</span></label>
											<input id="inputName" name="foccp" type="text" class="form-control"  required>
											<div class="help-block with-errors"></div>
										</div>
									...
									<div class="col-md-12">
										...
										<div class="form-group">
											<label for="inputName">Mother's Name <span class="font10 text-danger">(required)</span></label>
											<input id="inputName" name="mname" type="text" class="form-control"  required>
											<div class="help-block with-errors"></div>
										</div>
									...
									<div class="col-md-12">
										...
										<div class="form-group">
											<label for="inputName">Mother's occupation <span class="font10 text-danger">(required)</span></label>
											<input id="inputName" name="moccp" type="text" class="form-control"  required>
											<div class="help-block with-errors"></div>
										</div>
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											<label for="inputName">10+2 (%age)</label>
											<input id="inputName" name="percen1" type="text" class="form-control"  >
											<div class="help-block with-errors"></div>
										</div>
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											...
											<input id="inputName" name="yop1" type="text" class="form-control"  >
											<div class="help-block with-errors"></div>
										</div>
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											...
											<input id="inputName" name="city1" type="text" class="form-control">
											<div class="help-block with-errors"></div>
										</div>
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											<label for="inputName">UG (%age)</label>
											<input id="inputName" name="percen2" type="text" class="form-control" >
											<div class="help-block with-errors"></div>
										</div>
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											<label for="inputName">Year of passing </label>
											<input id="inputName" name="yop2" type="text" class="form-control" >
											<div class="help-block with-errors"></div>
										</div>
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											<label for="inputName">City</label>
											<input id="inputName" name="city2" type="text" class="form-control" >
											<div class="help-block with-errors"></div>
										</div>
            ...
            <div class="useful col-md-4" style="text-align:right; ">
                    <h3>Some Useful Links</h3>
                    <ul>
                      <li><a href="form2.php">Undertaking Form</a></li>
                      <li><a href="msc.php">MSC Program</a></li>
                       <li><a href="visa.php">Visa Assistance</a></li>
