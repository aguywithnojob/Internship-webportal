...
<body class="not-transparent-header">
	...
	<div class="container-wrapper">
		...
		<div class="main-wrapper">
            ...
            <li><span>Undertaking form</span></li>
					</ol>
        ...
        <div class="container">
          ...
          <div class="row">
			...
			<section>
                ...
                <form  method="post" class="contact-form-wrapper" data-toggle="validator" action="submit2.php">
               <div class="col-sm-7 col-md-5 col-md-offset-1 mb-30">
                <div class="row">
                   <h3>Undertaking By Student</h3>
                  <div class="col-md-6">
                  
                    <div class="form-group">
                      <label for="inputName">I Mr./Ms. <span class="font10 text-danger">(required)</span></label>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label for="inputName">S/o/D/o <span class="font10 text-danger">(required)</span></label>
                      <input id="inputName" name="sod" type="text" class="form-control" required>
                      <div class="help-block with-errors"></div>
                    </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      <label for="inputName">R/O<span class="font10 text-danger">(required)</span></label>
                      <input id="inputName" name="ro" type="text" class="form-control"  required>
                      <div class="help-block with-errors"></div>
                    </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label for="inputName">Mobile<span class="font10 text-danger">(required)</span></label>
                      <input id="inputName" name="phone" type="text" class="form-control"  required>
                      <div class="help-block with-errors"></div>
                    </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label for="inputEmail">Course <span class="font10 text-danger">(required)</span></label>
                      <input id="inputEmail" name="course" type="text" class="form-control"  required>
                      <div class="help-block with-errors"></div>
                    </div>
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="form-group">
                      <label for="inputEmail">Semester <span class="font10 text-danger">(required)</span></label>
                      <input id="inputEmail"  name="semester"type="text" class="form-control"  required>
                      <div class="help-block with-errors"></div>
                    </div>
                  ...
                  <div class="col-md-8">
                    ...
                    <div class="form-group">
                      ...
                      <input id="inputEmail" name="rollno" type="text" class="form-control"   required>
                      <div class="help-block with-errors"></div>
                    </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label for="inputName">Session <span class="font10 text-danger">(required)</span></label>
                      <input id="inputName" name="session" type="text" class="form-control"  placeholder="YYYY-YYYY"required>
                      <div class="help-block with-errors"></div>
                    </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label for="inputName">Year <span class="font10 text-danger">(required)</span></label>
                      <input id="inputName" name="year" type="text" class="form-control" placeholder="DD/MM/YYYY" required>
                      <div class="help-block with-errors"></div>
                    </div>
                   ...
                   <div class="col-sm-7 col-md-4 col-md-offset-1 mb-30">
                      <h3>Undertaking By Parents</h3>
                      <div class="col-md-12">
                  
                    <div class="form-group">
                      <label for="inputName">Parents Name <span class="font10 text-danger">(required)</span></label>
                      <input id="inputName" name="pname" type="text" class="form-control"  required>
                      <div class="help-block with-errors"></div>
                    </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      <label for="inputName">Student Name <span class="font10 text-danger">(required)</span></label>
                      <input id="inputName" name="sname" type="text" class="form-control" required>
                      <div class="help-block with-errors"></div>
                    </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      <label for="inputName">University/College<span class="font10 text-danger">(required)</span></label>
                      <input id="inputName" name="college" type="text" class="form-control"  required>
                      <div class="help-block with-errors"></div>
                    </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      <label for="inputName">Department<span class="font10 text-danger">(required)</span></label>
                      <input id="inputName" name="dpt" type="text" class="form-control"  required>
                      <div class="help-block with-errors"></div>
                    </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      <label for="inputEmail">Phone(mobile) <span class="font10 text-danger">(required)</span></label>
                      <input id="inputEmail" name="mobile" type="text" class="form-control"  required>
                      <div class="help-block with-errors"></div>
                    </div>
                   </div>
                    <div class="col-sm-12 text-right">
                    <button type="submit" name="submit2" class="btn btn-primary mt-5">Send Message</button>
                  </div>
              </form>
