...
<div id='cssmenu'>
        ...
        <h2>Currency Of Your Country</h2>
        <h3>Choose one</h3>
...
<!-- Note that the amount is in paise = 50 INR -->
          ...
          <div class="col-sm-12 col-md-6 ">
                     <h4>Rs. 160000.00/-</h4>
                    <button type="submit" name="inr" value="inr" class="btn btn-primary mt-5">INR(Rupee)</button>
           </div>
           <div class="col-sm-12 col-md-6 ">
                    <h4>€ 2000 -> Rs. 160000.00/-</h4>
                    <button type="submit" name="euro" value="euro" class="btn btn-primary mt-5">EURO(€)</button>
           </div>
    </form>
</div>
</div>
