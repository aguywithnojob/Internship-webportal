...
<div id='cssmenu'>
        ...
        <h2>Duration of courses</h2>
        <h3>Choose one</h3>
		<form action="currency.php" method="post">
<!-- Note that the amount is in paise = 50 INR -->
         
          <div class="col-sm-12 col-md-6 ">
                    <button type="submit" name="2weeks" value="2weeks" class="btn btn-primary mt-5">2 Weeks</button>
           </div>
           <div class="col-sm-12 col-md-6 ">
                    <button type="submit" name="3weeks" value="3weeks" class="btn btn-primary mt-5">3 Weeks</button>
           </div>
    </form>
</div>
</div>
