...
<body class="not-transparent-header">
	...
	<div class="container-wrapper">
		...
		<!-- start Main Wrapper -->
			<div class="breadcrumb-wrapper bt">
		...
		<div class="main-wrapper">
			...
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13996.694700548473!2d77.15034522558388!3d28.714355268167058!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjjCsDQyJzUxLjciTiA3N8KwMDknMzIuOCJF!5e0!3m2!1sen!2sin!4v1523986811962" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
			...
			<div class="section sm pb-20" style="padding:0px;">
				...
				<div class="container">
					...
					<form method="post" action="sendmail.php" class="contact-form-wrapper" data-toggle="validator" >
								...
								<div class="row">
									...
									<div class="col-sm-12">
										...
										<div class="form-group">
											...
											<textarea id="inputMessage" class="form-control" name="message" rows="8" data-minlength="10" data-error="Your message is required and must not less than 10 characters" required></textarea>
											<div class="help-block with-errors"></div>
										</div>
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address>      Ju-41/A, Pitampura <br/>New Delhi-110088<br/>India </address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:dharnigupta.qcs@gmail.com">dharnigupta.qcs@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:27348290">27348290.</a>
								</li>
								<li>
										<h5>Mobile</h5><a href="tel:9811471978">9811471978.</a>
								</li>
